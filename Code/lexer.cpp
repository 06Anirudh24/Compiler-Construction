...
void tokenizer(vector<char> b1, vector<char> b2, ifstream &code, int size){
    ...
    while(flag==0){
        ...
        switch(state){
            ...
            case 1: cout<<"Token 1, string +, line number"<<line<<endl; 
                    ...
                    state=0;
                    break;
            case 2: cout<<"Token 2, string -, line number"<<line<<endl; 
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    state=0;
                    break;
            case 3: cout<<"Token 3, string *, line number"<<line<<endl; 
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    state=0;
                    break;
            case 4: cout<<"Token 4, string /, line number"<<line<<endl; 
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    state=0;
                    break;
            case 5: cout<<"Token 5, string %, line number"<<line<<endl; 
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    state=0;
                    break;
            case 6: cout<<"Token 6, string {, line number"<<line<<endl; 
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    state=0;
                    break;
            case 7: cout<<"Token 7, string }, line number"<<line<<endl; 
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    state=0;
                    break;
            case 8: cout<<"Token 8, string (, line number"<<line<<endl; 
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    state=0;
                    break;
            case 9: cout<<"Token 9, string ), line number"<<line<<endl; 
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    state=0;
                    break;
            case 10: cout<<"Token 10, string [, line number"<<line<<endl; 
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    state=0;
                    break;
            case 11: cout<<"Token 11, string ], line number"<<line<<endl; 
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    state=0;
                    break;
            case 12: cout<<"Token 12, string ;, line number"<<line<<endl; 
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    state=0;
                    break;
            case 13: cout<<"Token 13, string ,, line number"<<line<<endl; 
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    state=0;
                    break;
            case 14: cout<<"Token 14, string ?, line number"<<line<<endl; 
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    state=0;
                    break;
            case 18: cout<<"Token 18, string :, line number"<<line<<endl; 
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
            ...
            case 15: if(c=='=') {state=16; break;}
                    cout<<"Token 15, string =, line number "<<line<<endl;
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
            ...
            case 16: if(c=='=') {state=17; break;}
                    cout<<"Token 16, string ==, line number "<<line<<endl;
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    break;
            //tokenizes ===
            case 17: cout<<"Token 17, string ===, line number "<<line<<endl;
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
            ...
            case 19: if(c=='=') {state=20; break;}
                    cout<<"Token 19, string >, line number "<<line<<endl;
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    break;
            //tokenizes >=
            case 20: cout<<"Token 20, string >=, line number "<<line<<endl;
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
            ...
            case 21: if(c=='=') {state=22; break;}
                    cout<<"Token 21, string <, line number "<<line<<endl;
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    break;
            //tokenizes <=
            case 22: cout<<"Token 22, string <=, line number "<<line<<endl;
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
            ...
            case 23: if(c=='=') {state=24; break;}
                    cout<<"Token 23, string !, line number "<<line<<endl;
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
            ...
            case 24: if(c=='=') {state=25; break;}
                    cout<<"Token 24, string !=, line number "<<line<<endl;
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    break;
            //tokenizes !==
            case 25: cout<<"Token 25, string !==, line number "<<line<<endl;
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
            ...
            case 26: if(c=='&') {state=27; break;}
                    cout<<"Token 26, string &, line number "<<line<<endl;
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    break;
            //tokenizes &&
            case 27: cout<<"Token 27, string &&, line number "<<line<<endl;
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
            ...
            case 28: if(c=='|') {state=29; break;}
                    cout<<"Token 28, string |, line number "<<line<<endl;
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
                    ...
                    break;
            //tokenizes ||
            case 29: cout<<"Token 29, string ||, line number "<<line<<endl;
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
			...
			case 31: if(tokens.count(temp)){
                        cout<<"Token "<<tokens[temp]<<", string "<<temp<<",line number "<<line<<endl;
                        ...
                        cout<<"Token 30, string "<<temp<<", line number "<<line<<endl;
                        if(filepointer>1) filepointer-=2;
                        else{
                            if(filepointer==1) filepointer=size-1;
                            else filepointer=size-2;
            ...
            case 44: cout<<"Token 44, string "<<number<<", line number "<<line<<endl;
            ...
            case 46: cout<<"Token 46, string "<<number<<", line number "<<line<<endl;
                    if(filepointer>1) filepointer--;
                    else{
                        if(filepointer==1) filepointer=size-1;
                        else filepointer=size-2;
            ...
            case 47: if(c=='"'){state=48; break;}
                    ...
                    break;
            //tokenizes as string
            case 48: cout<<"Token 48, string "<<word<<", line number "<<line<<endl;
                    if(filepointer>0) filepointer--;
                    else{
                        filepointer=size-1;
                        if(x==1) x=2;
            ...
            case 100: cout<<"Error: Lexical error in line number "<<line<<endl; state=0; filepointer-=1; break;
        }
        //checks if the string in the input code has been terminated or not
        if(flag==1){
            if(state==47) cout<<"Error: String literal not terminated in line number "<<line<<endl;
            break;
        }
        if(filepointer<size-1) filepointer++;
        //eof case
